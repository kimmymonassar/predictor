...
RUN apt-get update -y && apt-get install -y libsm6 libxrender1 libfontconfig1 libglib2.0 libxext-dev libxtst-dev build-essential cmake git libgtk2.0-dev pkg-config libavcodec-dev libavformat-dev libswscale-dev
